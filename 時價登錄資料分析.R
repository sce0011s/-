...
#######################################################################################################################################
#選取分析用資料
# data <- read.xlsx("C:\\Users\\steven\\Desktop\\時價登錄資料\\housing_data.xlsx") #讀取資料
...
# tuneRF(test_data[,-13],test_data[,13])
# plot(forest_model)
